...
FROM (
  SELECT
    ...
    $1:region_type STRING,
    $1:region_type_id INT,
    $1:table_id INT,
    $1:is_seasonally_adjusted STRING,
    $1:city STRING,
    $1:state STRING,
    $1:state_code STRING,
    $1:property_type STRING,
    $1:property_type_id INT,
    $1:median_sale_price FLOAT,
    $1:median_list_price FLOAT,
    $1:median_ppsf FLOAT,
    $1:median_list_ppsf FLOAT,
    $1:homes_sold FLOAT,
    $1:inventory FLOAT,
    $1:months_of_supply FLOAT,
    $1:median_dom FLOAT,
    $1:avg_sale_to_list FLOAT,
    $1:sold_above_list FLOAT,
    $1:parent_metro_region_metro_code STRING,
    $1:last_updated DATETIME,
    $1:period_begin_in_years STRING,
    $1:period_end_in_years STRING,
    $1:period_begin_in_months STRING,
    $1:period_end_in_months STRING
